...
TEST(InferenceSessionTests, TestTruncatedSequence) {
  ...
  std::ifstream model_file_stream(LSTM_MODEL_URI, ios::in | ios::binary);
  ASSERT_TRUE(model_file_stream.good());
  ...
  std::vector<float> Y_data = {-0.000538226f, 0.000135986f,
                               -0.00145597f, 0.000262419f,
                               -0.00236454f, 0.000250193f,
                               -0.00293309f, 0.000100311f,
